...
const listingSchema = new mongoose.Schema({
    ...
    image: { 
        filename: String,
        url: { type: String, default: "https://png.pngtree.com/png-vector/20190909/ourmid/pngtree-house-logo-designs-inspiration-isolated-on-white-background-png-image_1726009.jpg", // default image URL
